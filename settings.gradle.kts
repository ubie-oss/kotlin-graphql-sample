...
pluginManagement {
    resolutionStrategy {
        ...
        val sprintBootVersion: String by settings
        eachPlugin {
            when (requested.id.id) {
                ...
                "io.spring.dependency-management", "org.springframework.boot" -> useModule("org.springframework.boot:spring-boot-gradle-plugin:$sprintBootVersion")
